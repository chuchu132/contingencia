...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('City.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('City.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Editar Ciudad'); ?></h2>
