...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">			
						<li class="list-group-item"><?php echo $this->Html->link(__('Editar Tipo de Operación'), array('action' => 'edit', $operationType['OperationType']['id']), array('class' => '')); ?> </li>
		<li class="list-group-item"><?php echo $this->Form->postLink(__('Eliminar Tipo de Operación'), array('action' => 'delete', $operationType['OperationType']['id']), array('class' => ''), __('Are you sure you want to delete # %s?', $operationType['OperationType']['id'])); ?> </li>
		<li class="list-group-item"><?php echo $this->Html->link(__('Lista de Tipos de Operaciones'), array('action' => 'index'), array('class' => '')); ?> </li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="operationTypes view">
			...
			<h2><?php  echo __('Tipo de Operación'); ?></h2>
		...
		<td>
			<?php echo h($operationType['OperationType']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Updated'); ?></strong></td>
		<td>
			<?php echo h($operationType['OperationType']['updated']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="related">
				...
				<?php if (!empty($operationType['Publication'])): ?>
		...
		<th><?php echo __('User Id'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($operationType['Publication'] as $publication): ?>
		<tr>
