...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">			
						<li class="list-group-item"><?php echo $this->Html->link(__('Editar Tipo de Propiedad'), array('action' => 'edit', $propertyType['PropertyType']['id']), array('class' => '')); ?> </li>
		<li class="list-group-item"><?php echo $this->Form->postLink(__('Eliminar Tipo de Propiedad'), array('action' => 'delete', $propertyType['PropertyType']['id']), array('class' => ''), __('Are you sure you want to delete # %s?', $propertyType['PropertyType']['id'])); ?> </li>
		<li class="list-group-item"><?php echo $this->Html->link(__('Lista de Tipos de Propiedades'), array('action' => 'index'), array('class' => '')); ?> </li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<td>
			<?php echo h($propertyType['PropertyType']['category']); ?>
			&nbsp;
		</td>
		...
		<td>
			<?php echo h($propertyType['PropertyType']['updated']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="related">
				...
				<?php if (!empty($propertyType['Publication'])): ?>
